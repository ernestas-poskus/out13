...
#### <a href="https://github.com/AnsibleShipyard">AnsibleShipyard</a>

> Contributing to major Ansible playbooks (Zookeeper, Mesos, Marathon, etc.) and managing releases.

> https://github.com/AnsibleShipyard

#### <a href="http://gophers.lt/">Vilnius Golang</a>
> Organizer of Google Golang programming language meetups. Sole purpose is to form Golang community in Lithuania to promote new ways of solving distributed systems, concurrent software paradigms & problems.

> http://www.meetup.com/Vilnius-golang
...
- Languages: Golang, Ruby, Rust, CoffeeScript
- Databases: MySQL, PostgreSQL
- NoSQL: Redis, Cassandra, Elasticsearch
- Editor: emacs, vim
- Cloud Services: Heroku
- Queues: NSQ, Kafka
- IT automation: Ansible and Chef
- Shell: bash, zsh, tmux
- VCS: git
...
###### June 2016 – present
 ...
 - Services migration to systemd
 - Ansible playbooks for orchestration
 - Elasticsearch scaling and upgrading
 - Jenkins configuration & jobs management
 - Deployment pipeline improvement
 - Bootstrapping of new servers


```
Chef, Deployment pipeline, Ansible, systemd
```

### Backend developer @ [Vinted](http://vinted.com/)
##### Peer-to-peer marketplace for women and men to sell, buy and swap clothes.
###### October 2015 – June 2016 (9 months)
 - Elasticsearch research & development
 - Merchandising tools
 - Content balancing

```
Elasticsearch, score functions and complex querying
```
...
---- | ----------- | ---- | -----------
[Cloud Networking](https://www.coursera.org/account/accomplishments/records/4LZFCFUgj2wYLKL4) | University of Illinois at Urbana-Champaign | December 2015 – Present | ![Cloud Networking](/certificates/cc4.jpg)
[Cloud Computing Applications](https://www.coursera.org/learn/cloud-applications-part1) | University of Illinois at Urbana-Champaign | October 2015 – Present | ![Cloud Computing Concepts](/certificates/cc3.jpg)
